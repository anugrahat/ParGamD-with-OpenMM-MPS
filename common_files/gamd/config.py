...
class IntegratorNumberOfStepsConfig:
    ...
    def serialize(self, root):
        ...
        assign_tag(root, "extension-steps", self.extension_steps)
    ...
    def compute_total_simulation_length(self):
        ...
        self._original_total_length = base_total
        if self.extension_steps > 0:
             self.total_simulation_length = base_total + self.extension_steps
        else:
             self.total_simulation_length = base_total
        return self.total_simulation_length
